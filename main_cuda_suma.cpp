...
static const std::string filename = "D:/Programacion Paralela/grupal_main2/im1.jpg";
static const std::string filename1 = "D:/Programacion Paralela/grupal_main2/im2.jpg";
...
const sf::Uint8 * host_src_image_pixels1 = nullptr;
sf::Uint8 * host_blur_image_pixels = nullptr;

sf::Uint8 * device_src_image_pixels = nullptr;
sf::Uint8 * device_src_image_pixels1 = nullptr;
...
void convert_image_to_gray_scale() {
    ...
    CHECK(cudaMemcpy(device_src_image_pixels1, host_src_image_pixels1, buffer_size, cudaMemcpyHostToDevice));

    kernel_add(device_src_image_pixels, device_src_image_pixels1,device_blur_image_pixels, image_width, image_height, blur_dimension/2);
...
int main() {
    ...
    sf::Image im2;
    im2.loadFromFile(filename1);
    host_src_image_pixels = im.getPixelsPtr();
    host_src_image_pixels1 = im2.getPixelsPtr();
    ...
    CHECK(cudaMalloc(&device_src_image_pixels1, buffer_size));
    ...
    CHECK(cudaFree(device_src_image_pixels1));
