...
static const std::string filename = "D:/Programacion Paralela/grupal_main2/image01.jpg";
...
void convert_image_to_gray_scale() {
    ...
    kernel_gray(device_src_image_pixels, device_blur_image_pixels, image_width, image_height, blur_dimension/2);
